...
public class EmployeeDAO extends  SimpleJdbcDaoSupport  implements IDAO {
	...
	public void insertRecord(Object obj) {
		...
		if(obj instanceof Employee)
		{
			...
			{	
				...
				getSimpleJdbcTemplate().update(empInsert,new Object[] {emp.getEmpid(),emp.getFirstname(),emp.getLastname()});
			}
	...
	public void updateRecord(Object obj)
	{
		...
		{
			Employee emp = (Employee)obj;
			getSimpleJdbcTemplate().update(empUpdate,new Object[] {emp.getFirstname(),emp.getLastname(),emp.getEmpid()});
		}
	}
	...
	public Object retrieveRecord(int empid)
	{
		...
		List emps = getSimpleJdbcTemplate().query(empSelect,new ParameterizedRowMapper() {
